...
# -*- coding: utf-8 -*-
"""
NeuraLink Intel AI - Simple Apple Design Demo
简化版苹果风格演示 (无外部依赖)
"""
...
def main():
    ...
    <div class="apple-hero">
        ...
        <p><strong>Think Different. Think Intel. Think Better.</strong></p>
    ...
    with tab1:
        ...
        if st.button("🚀 开始演示对话", use_container_width=True):
            ...
            sample_conversations = [
                ...
                {
                    'user': "今天和朋友一起玩游戏，特别开心",
                    'ai': "和朋友一起玩游戏确实很快乐！友谊是很珍贵的，你们玩了什么有趣的游戏呢？",
                    'emotion': "正面",
                    'confidence': 0.95
                }
            ]
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown("### 🎨 Apple Design System")
        st.success("**设计理念**: 简洁、直观、美观")
        st.info("**视觉语言**: SF Pro Display字体")
        st.warning("**交互体验**: 流畅、自然、高效")
